...
class Category(models.Model):
    cid = ShortUUIDField(unique=True, max_length=22)  # removed length, prefix, alphabet
...
class Vendor(models.Model):
    vid = ShortUUIDField(unique=True, max_length=22)  # removed length, prefix, alphabet
